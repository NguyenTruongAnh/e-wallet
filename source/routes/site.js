...
const { checkAuth, checkAuth2 } = require('../app/middlewares/check')
...
router.post('/recovery2-otp', checkAuth2, siteController.Recovery2OTP)

router.post('/recovery2-password', checkAuth2, siteController.Recovery2Password)
...
router.post('/recovery',
    ...
    handleValidation,
    siteController.Recovery)

router.post('/reset-password', checkAuth,
    body('password').notEmpty().withMessage('Vui lòng nhập mật khẩu!'),
    body('confirm-password').notEmpty().withMessage('Vui lòng nhập xác thực mật khẩu!')
        .custom((value, { req }) => {
