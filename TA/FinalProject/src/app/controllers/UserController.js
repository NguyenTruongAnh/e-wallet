...
class UserController {
    ...
    getCard(req, res, next) {
        res.render('user/card.hbs', { layout: 'userLayout', title: 'AVAT - Mua thẻ điện thoại' })
    }
    ...
    getTransfer(req, res, next) {
        res.render('user/transfer.hbs', { layout: 'userLayout', title: 'AVAT - Chuyển tiền' })
    }
    ...
    getWithdraw(req, res, next) {
        res.render('user/withdraw.hbs', { layout: 'userLayout', title: 'AVAT - Rút tiền' })
    }
